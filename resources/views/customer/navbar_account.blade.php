<div class="bg-white font-inter font-extralight text-2xl"
    ...
    <header 
      class="fixed inset-x-0 z-50 transition-all duration-300 py-0" 
      ...
      <nav
        class="flex items-center justify-between p-6 lg:px-8 transition-all duration-300 bg-primary"
                  ...
                  >
                    <div class="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                      @if(auth()->user()->isCustomer())
                        ...
                        <a href="{{ route('customer.profile') }}" class="block px-4 py-6 text-sm text-primary hover:text-orange-500" role="menuitem">Pengaturan Account</a>
                      @endif
                    ...
                    <div class="relative inline-block text-left" x-data="{ open: false }">
                      ...
                      >
                        <div class="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                          ...
                          <a href="#" class="block px-4 py-2 text-sm text-gray-700 focus:text-orange-400" role="menuitem">Pengaturan Account</a>
                          <form method="POST" action="{{ route('logout') }}">
